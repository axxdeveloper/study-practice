...
@SpringBootTest
public class KafkaTransactionalReadUncommittedTest extends IntegrationTest {
    ...
    public void test() {
        try (
            ...
            KafkaConsumer<String, String> consumer = consumer_read_uncommitted(TX_REQ_TOPIC_1)) {
